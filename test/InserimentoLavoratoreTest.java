...
class InserimentoLavoratoreTest {
    ...
    void getDataTest() {
        ...
        LocalDate LOCAL_DATE_3 = LocalDate.of(2006, 9, 27);
    ...
    void controlloDatePerComuni() {
        ...
        boolean controlCorretto1 = inserimentoLavoratore.controlloDatePerComuni("09/2023", "10/2023", "Balme", "Balme");
        boolean controlCorretto2 = inserimentoLavoratore.controlloDatePerComuni("09/2022", "12/2023", "Balme", "Balme");
        boolean controlCorretto3 = inserimentoLavoratore.controlloDatePerComuni("09/2022", "12/2023", "Balme", "Arignano");
        boolean controlCorretto4 = inserimentoLavoratore.controlloDatePerComuni("09/2023", "08/2023", "Balme", "Arignano");
        boolean controlErrato1 = inserimentoLavoratore.controlloDatePerComuni("10/2023", "01/2023", "Balme", "Balme");
        boolean controlErrato2 = inserimentoLavoratore.controlloDatePerComuni("10/2023", "10/2023", "Balme", "Balme");
    ...
    void controlloComuniInListaTest() throws FileNotFoundException {
        ...
        boolean controlCorretto1 = inserimentoLavoratore.controlloComuniInLista("Arignano");
        boolean controlCorretto2 = inserimentoLavoratore.controlloComuniInLista("Balme");
        boolean controlErrato1 = inserimentoLavoratore.controlloComuniInLista("Test");
        boolean controlErrato2 = inserimentoLavoratore.controlloComuniInLista("Balm€!");
    ...
    void controlloNazioniListaTest() throws FileNotFoundException {
        ...
        boolean controlErrato1 = inserimentoLavoratore.controlloNazioniLista("Test");
        boolean controlErrato2 = inserimentoLavoratore.controlloNazioniLista("Balm€!");
