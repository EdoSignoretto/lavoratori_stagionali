...
public class ModificaLavoro {
    ...
    public void setCampi(Lavoro lavoro){
        insLavoro.setText(lavoro.getNomeLavoro());
        nomeAzienda.setText(lavoro.getNomeAzienda());
        luogoLavoro.setText(lavoro.getLuogoLavoro());
        retribuzioneLorda.setText(String.valueOf(lavoro.getRetribuzioneLorda()));
        retribuzioneGiornaliera.setText(String.valueOf(lavoro.getRetribuzioneGiornaliera()));
        mansione_1.setText(lavoro.getMansione_1());
        mansione_2.setText(lavoro.getMansione_2());
        data_inizio.setText(lavoro.getDataInizio());
        data_fine.setText(lavoro.getDataFine());
    ...
    public boolean controlloComuniInLista(String comune) throws FileNotFoundException {
        File getCSVFiles = new File("/src/sample/utils/comuni.csv");
